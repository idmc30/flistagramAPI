...
$app->group('/api/v1', function () {
    ...
    $this->group('/user', function () {
        ...
        $this->post('/find', 'UserController:find_users');
    });
    ...
    $this->group('/publication', function () {
        ...
        $this->get('/data/{id_publication}', 'PublicationController:get_publication');
    ...
    $this->group('/storage', function () {
        ...
        $this->get('/u/{username}/profile.jpg', 'UserController:get_profile_image');
    });
});